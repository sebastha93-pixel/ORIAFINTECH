...
export class AssetsController {
  ...
  @Put('assets/:id')
  updateAsset(@CurrentUser() user: User, @Param('id') id: string, @Body() dto: Partial<CreateAssetDto>) { return this.service.updateAsset(user.id, id, dto); }
  ...
  @Put('liabilities/:id')
  updateLiability(@CurrentUser() user: User, @Param('id') id: string, @Body() dto: Partial<CreateLiabilityDto>) { return this.service.updateLiability(user.id, id, dto); }
