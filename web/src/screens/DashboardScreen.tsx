  ...
  return (
    <div style={{ paddingBottom: 100 }}>
      ...
      <div style={{ padding:'20px 16px', display:'flex', flexDirection:'column', gap:20 }}>
        ...
        {/* Accounts */}
        <Section title="Mis Cuentas" action={ACCOUNTS.length ? 'Ver todas' : undefined}>
          {ACCOUNTS.length === 0
            ? <Empty icon="🏦" text="Conecta Gmail para importar tus cuentas automáticamente" />
        ...
        <Section title="Movimientos recientes" action={TRANSACTIONS.length ? 'Ver todos' : undefined}>
          {TRANSACTIONS.length === 0
            ? <Empty icon="💸" text="Ve a Ajustes y conecta Gmail para importar tus movimientos automáticamente" />
            : <div style={{ ...card }}>
