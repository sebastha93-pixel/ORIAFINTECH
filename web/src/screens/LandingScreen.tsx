    ...
    <div style={{ background: '#060D1A', color: '#F7F9FC', fontFamily: 'Inter, system-ui, sans-serif', overflowX: 'hidden' }}>
              ...
              <div style={{ padding: '8px 16px 80px', boxSizing: 'border-box', overflowY: 'hidden', height: 'calc(100% - 44px)' }}>
                ...
                <div style={{ background: 'linear-gradient(135deg, rgba(49,214,123,0.1) 0%, rgba(96,165,250,0.07) 100%)', border: '1px solid rgba(49,214,123,0.18)', borderRadius: 18, padding: '16px', marginBottom: 14 }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <div><div style={{ color: '#475569', fontSize: 8, marginBottom: 2 }}>Activos</div><div style={{ color: '#31D67B', fontSize: 11, fontWeight: 700 }}>$10.4M</div></div>
                    <div><div style={{ color: '#475569', fontSize: 8, marginBottom: 2 }}>Deudas</div><div style={{ color: '#F87171', fontSize: 11, fontWeight: 700 }}>$2.16M</div></div>
                    <div><div style={{ color: '#475569', fontSize: 8, marginBottom: 2 }}>Ahorro</div><div style={{ color: '#60A5FA', fontSize: 11, fontWeight: 700 }}>28%</div></div>
                  </div>
                </div>
      ...
      <section style={{ padding: '100px 24px', background: 'rgba(255,255,255,0.015)', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 64 }}>
            ...
            <h2 style={{ fontSize: 'clamp(26px, 4vw, 42px)', fontWeight: 900, letterSpacing: -0.8, margin: '0 0 16px', lineHeight: 1.15 }}>Diseñada para personas que<br />toman sus finanzas en serio</h2>
          </div>
      ...
      <section style={{ padding: '100px 24px' }}>
        <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: 'clamp(26px, 4vw, 44px)', fontWeight: 900, lineHeight: 1.12, letterSpacing: -1, margin: '0 0 20px' }}>Tu información<br /><span style={{ color: '#60A5FA' }}>siempre te pertenece.</span></h2>
          <p style={{ color: '#475569', fontSize: 16, lineHeight: 1.85, margin: '0 0 60px' }}>ORIA no accede a tus contraseñas bancarias, no puede mover tu dinero y nunca vende tus datos.</p>
      ...
      <section id="instalar" style={{ padding: '80px 24px', background: 'rgba(96,165,250,0.03)', borderTop: '1px solid rgba(96,165,250,0.08)', borderBottom: '1px solid rgba(96,165,250,0.08)' }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            <h2 style={{ fontSize: 'clamp(24px, 4vw, 36px)', fontWeight: 900, margin: '0 0 12px', letterSpacing: -0.5 }}>Instala ORIA en tu celular</h2>
            <p style={{ color: '#475569', fontSize: 15, margin: 0 }}>Sin App Store. Sin actualizaciones manuales. Se instala directo desde el navegador.</p>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20, marginBottom: 36 }}>
            ...
            <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 20, padding: '28px 24px' }}>
              ...
              {['Abre oriafintech.com en Safari', 'Toca el botón □↑ en la barra inferior de Safari', 'Despázate y selecciona "Añadir a pantalla de inicio"', 'Confirma el nombre y toca "Añadir". Listo.'].map((step, i) => (
                <div key={i} style={{ display: 'flex', gap: 12, marginBottom: 14, alignItems: 'flex-start' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            {installed ? (
              ...
              <button onClick={handleInstall} style={{ padding: '15px 40px', borderRadius: 14, border: 'none', background: 'linear-gradient(135deg, #3B82F6, #1D4ED8)', color: '#fff', fontSize: 15, fontWeight: 700, cursor: 'pointer', boxShadow: '0 8px 32px rgba(59,130,246,0.22)' }}>Instalar ORIA ahora</button>
            ) : isIOS ? (
              <p style={{ color: '#475569', fontSize: 14, margin: 0 }}>En iPhone: toca <strong style={{ color: '#94A3B8' }}>□↑</strong> en Safari y luego <strong style={{ color: '#94A3B8' }}>"Añadir a pantalla de inicio"</strong></p>
            ) : (
              <button onClick={onStart} style={{ padding: '15px 40px', borderRadius: 14, border: 'none', background: '#31D67B', color: '#041A0D', fontSize: 15, fontWeight: 700, cursor: 'pointer' }}>Usar desde el navegador →</button>
            )}
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '120px 24px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 600, margin: '0 auto', position: 'relative' }}>
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 32 }}><OriaLogo size={52} /></div>
          ...
          <p style={{ color: '#475569', fontSize: 16, lineHeight: 1.85, margin: '0 0 40px' }}>Únete. Entiende tu dinero. Toma mejores decisiones. Avanza.</p>
          <button onClick={onStart} style={{ padding: '18px 56px', borderRadius: 16, border: 'none', background: '#31D67B', color: '#041A0D', fontSize: 17, fontWeight: 800, cursor: 'pointer', boxShadow: '0 12px 48px rgba(49,214,123,0.22)', letterSpacing: -0.3 }}>Comenzar gratis</button>
